...
class DeleteItemUseCaseTest {
    ...
    @Test
    void deleteItemByCode() {

        when(itemPort.deleteItem(ItemMock.CODE)).thenReturn(ItemMock.getItem());

        StepVerifier
                .create(deleteItemUseCase.deleteItemByCode(ItemMock.CODE))
        ...
        verify(itemPort).deleteItem(ItemMock.CODE);
